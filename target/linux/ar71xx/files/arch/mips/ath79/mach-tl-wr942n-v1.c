...
#define TL_WR942N_V1_KEYS_DEBOUNCE_INTERVAL	(3 * TL_WR942N_V1_KEYS_POLL_INTERVAL)
...
/*	{
		...
		.code			= KEY_WPS_BUTTON,
		.debounce_interval	= TL_WR942N_V1_KEYS_DEBOUNCE_INTERVAL,
		.gpio			= TL_WR942N_V1_GPIO_BTN_WPS,
		.active_low		= 1,
	},*/
};
...
static void __init tl_wr942n_v1_setup(void)
{
	...
	ath79_register_usb();
//	gpio_request_one(TL_WR942N_V1_GPIO_USB_POWER,
...
MIPS_MACHINE(ATH79_MACH_TL_WR942N_V1, "TL-WR942N-V1",
       "TP-LINK TL-WR942N v1", tl_wr942n_v1_setup);
